...
@Module({
  imports: [
     ...
     * حدود المعدل.
     *
     * حد `default` للطلبات العامة. login/logout/refresh معفاة منه؛ تسجيل الدخول
     * يملك عداد Redis مستقلًا لا يسجل إلا بيانات الدخول الخاطئة.
  ...
  providers: [
     ...
     *
     *   1. Throttler  — يحد الطلبات العامة؛ login يستخدم عداد الفشل المخصص.
