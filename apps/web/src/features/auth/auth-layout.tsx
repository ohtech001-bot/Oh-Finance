  ...
  return (
    <div className="relative min-h-dvh overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex min-h-dvh flex-col p-4 sm:p-6 lg:p-8">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                size="sm"
                className="border-amber-400/40 bg-black/60 text-white hover:bg-black/80 hover:text-white"
              >
        ...
        >
          <div dir="rtl" className="w-full max-w-md lg:max-w-[500px]">
            <div className="rounded-card border border-amber-400/35 bg-black/80 p-5 shadow-2xl backdrop-blur-sm sm:p-7">
              <div className="mb-6 text-center">
                <div
                  className="rounded-icon mx-auto flex size-12 items-center justify-center border border-amber-400/30 bg-amber-400/10"
                  aria-hidden
                >
            ...
            <div className="mt-4 flex flex-wrap items-center justify-center gap-x-3 gap-y-2 text-xs text-white/75">
              ...
              <span className="text-amber-400/45" aria-hidden>
                •
              </span>
              <Link
                to="/site-policy"
