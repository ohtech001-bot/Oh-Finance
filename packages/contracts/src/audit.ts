...
export const AUDIT_ACTIONS = {
  ...
  SUBSCRIPTION_BILLING_UPDATED: 'subscription.billing_updated',
  PLATFORM_STAFF_INVITED: 'platform.staff_invited',
  PLATFORM_STAFF_CREATED: 'platform.staff_created',
  PLATFORM_STAFF_UPDATED: 'platform.staff_updated',
  PLATFORM_STAFF_DELETED: 'platform.staff_deleted',
  PLATFORM_SUPPORT_STARTED: 'platform.support_started',
  PLATFORM_SUPPORT_ENDED: 'platform.support_ended',
  ...
  CUSTOMER_PURGED: 'customer.purged',
  ...
  ORDER_CUSTOMER_CREDIT_APPLIED: 'order.customer_credit_applied',
...
export const AUDIT_ACTION_LABELS: Record<string, string> = {
  ...
  'platform.staff_updated': 'تعديل مدير أو موظف منصة',
  'platform.staff_deleted': 'حذف مدير أو موظف منصة',
  'platform.support_started': 'بدء جلسة دعم لمحل',
  'platform.support_ended': 'إنهاء جلسة دعم لمحل',
  ...
  'customer.restored': 'استعادة زبون',
  'customer.purged': 'حذف زبون منتهي الأرشفة',
  ...
  'order.customer_credit_applied': 'استخدام رصيد الزبون',
